        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Initials = table.Column<string>(nullable: false, defaultValueSql: "char(3)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Games_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "PositionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Games_PlayerStatistics_PlayerStatisticPlayerId_PlayerStatisticGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Players_PlayerStatistics_PlayerStatisticPlayerId_PlayerStatisticGameId",
                        columns: x => new { x.PlayerStatisticPlayerId, x.PlayerStatisticGameId },
                        principalTable: "PlayerStatistics",
                        principalColumns: new[] { "PlayerId", "GameId" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_PositionId",
                table: "Games",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_PlayerStatisticPlayerId_PlayerStatisticGameId",
                table: "Games",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Players_PlayerStatisticPlayerId_PlayerStatisticGameId",
                table: "Players",
                columns: new[] { "PlayerStatisticPlayerId", "PlayerStatisticGameId" });
